...
const siteConfig = {
  // Algolia Search
  algolia: {
    apiKey: "8480456ebaab8cce2d9de9bd0338954b",
    indexName: "T37IGKZSWQ",
  ...
  headerIcon: "",
  footerIcon: "img/fav-kelvincosta.png",
  favicon: "img/fav-kelvincosta.png",

  /* Colors for website */
  colors: {
    primaryColor: "#dc2633",
    secondaryColor: "#2e2e39"
  },
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} KELVIN COSTA`,
